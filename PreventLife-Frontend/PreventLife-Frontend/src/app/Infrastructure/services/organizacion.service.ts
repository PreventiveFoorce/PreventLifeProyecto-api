...
import { Organizacion } from '../../Application/models/organizacion.model';
...
export class OrganizacionService {
  ...
  update(organizacion: Organizacion) {
    return this.http.put(`${this.apiBase}/organizaciones/${organizacion.idOrganizacion}`, organizacion);
  }
